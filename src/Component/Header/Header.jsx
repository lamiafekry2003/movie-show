...
export default function Header() {
  ...
  return (
    // <div className="w-full min-h-[70vh] lg:min-h-screen flex flex-col">
    ...
    //   </div>
    // </div>
    <div className="w-full min-h-[60vh] md:min-h-[80vh] lg:min-h-screen flex flex-col">
      <div className="flex flex-col flex-grow max-h-screen">
        <Carousel
          autoPlay={true}
          showArrows={false}
        ...
        >
          {isLoading ? (
            ...
            <div
              key={movie?.id}
              className="w-full h-[60vh] md:h-[80vh] lg:h-screen overflow-hidden relative group transition-all"
            >
              <div className="w-full h-full">
                <img
                  src={`https://image.tmdb.org/t/p/w500/${movie?.backdrop_path}`}
              ...
              <div className="container mx-auto">
                <div className="w-full absolute bottom-0 max-w-md">
                  ...
                  className="text-content pl-4 text-left">
                    ...
                    <Link to={`/home/${movie?.media_type}/${movie?.id}`}>
                      <button className="bg-white px-4 py-2 text-black font-bold rounded  lg:my-4 hover:bg-gradient-to-l from-red-700 to-orange-500 shadow-md transition-all hover:scale-105">
                        Play Now
                      </button>
                    </Link>
                  </motion.div>
