        ...
        <div className="flex  md:order-2">
          ...
          >
            ...
            <input
              type="text"
              id="search-navbar"
              className="block w-[110px] sm:w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Search..."
            />
          </div>
          <button
            ...
            data-collapse-toggle="navbar-search"
            type="button"
            className="inline-flex  items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden border-2 border-gray-300 focus:outline-none focus:ring-2 focus:border-gray-500 "
            aria-controls="navbar-search"
            aria-expanded="false"
          >
